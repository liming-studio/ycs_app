      ...
      >
        ...
        >
          <view 
            ...
            :class="priceActive === index ? 'border-primary bg-primary-10' : 'border-gray-300'"
          >
            <view>{{ item.title }}</view>
            <view 
              class="mt-6"
              :class="priceActive === index ? 'text-red' : 'text-gray-900'"  
            >
              <text>￥</text>
              <text class="text-xl">{{ item.price }}</text>
            </view>
            <view class="mt-6 text-xs text-gray-500">{{ item.text }}</view>
          </view>
        </u-grid-item>
      </u-grid>
...
export default {
  data() {
    return {
      ...
      priceActive: 0,
      priceList: [
        { title: '永久VIP', price: '7980.00', text: '每天仅需0.1元' },
        { title: '3年VIP', price: '5980.00', text: '每天仅需5元' },
        { title: '1年VIP', price: '4680.00', text: '每天仅需10元' },
        { title: '个人代理', price: '9980.00', text: '永久+50%返佣' },
      ],
      payActive: '支付宝',
      payList: [
